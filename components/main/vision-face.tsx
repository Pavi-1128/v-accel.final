...
export const VisionFace = () => {
  return (
    <section className="w-full py-4 sm:py-10 md:py-32 min-[2560px]:py-40">
      <motion.div
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, margin: "-100px" }}
      ...
      >
        ...
        >
          ...
          <motion.p
            ...
            className="text-base sm:text-lg md:text-xl text-gray-300 leading-relaxed"
          >
            VisionFace™ is a cutting-edge, on-premise facial recognition
            solution built for real-world use cases — hospitals, schools,
            corporate campuses, manufacturing units, and live events. Whether
            you&apos;re managing staff attendance, visitor entry, student
            tracking, or kiosk check-ins, VisionFace™ delivers unmatched
            accuracy and speed, even under challenging conditions like scarves,
            hats, glasses, or crowd density.
          </motion.p>
